...
#### The Code...
Keen to learn something new, I thought I'd dabble with a bit of [Single  Table Inheritance](http://en.wikipedia.org/wiki/Single_Table_Inheritance).
...
Thanks to [@relativesanity](http://www.twitter.com/relativesanity) for talking through the code and [markglenfletcher](https://github.com/markglenfletcher) for proof-reading an early version of this post.
